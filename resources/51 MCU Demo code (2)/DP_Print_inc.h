...
/*
** 串口发送1字节的函数 
** 需由客户在DP_Print_drv.c根据自己具体的单片机编写
** 函数名及参数需由这里一样
*/
...
/*
** 函数：void CheckPassWord(unsigned char *InputPassWord)
** 参数：输入8位密码
** 功能：验证厂家库使用密码
** 示例：如果厂家提供的密码为12345678，则调用CheckPassWord("12345678");
*/
void CheckPassWord(unsigned char *InputPassWord);
...
*/
#define	Ena_Set_Right_Interval	0
#if(Ena_Set_Right_Interval)
...
*/
#define	Ena_Set_Print_Mode	0
#if(Ena_Set_Print_Mode)
...
*/
#define	Ena_Set_Print_Position	0
#if(Ena_Set_Print_Position)
...
** 功能：设置左边间距
*/
#define	Ena_Set_Left_Interval	0
#if(Ena_Set_Left_Interval)
...
*/
#define		Ena_Sel_Custom_Character	0
#if(Ena_Sel_Custom_Character)
...
** 参数：mode 0 8-点 单密度
				 ...
				 pDotData 指向点阵数据的指针
*/
#define	Ena_Sel_Bitmap_Mode	0
#if(Ena_Sel_Bitmap_Mode)
...
** 参数：Opt 0 解除下划线模式
						 ...
						 2 设定2点粗下划线
*/
#define	Ena_Set_UnderLine	0
#if(Ena_Set_UnderLine)
...
** 功能：设置缺省行间距3.75mm
*/
#define	Ena_SetDefaultLineInterval	0
#if(Ena_SetDefaultLineInterval)
...
** 功能：取消自定义字符
*/
#define	Ena_Del_UserDefineCharacter	0
#if(Ena_Del_UserDefineCharacter)
...
** 参数：Position 水平定位位置
*/
#define	Ena_SetHorizPosition	0
#if(Ena_SetHorizPosition)
...
*/
#define	Ena_SelCountryCharacter	0
#if(Ena_SelCountryCharacter)
...
Bit7: 无意义
*/
#define	Ena_Get_Print_State	0
#if(Ena_Get_Print_State)
...
*/
#define	Ena_Sel_Align_Way	0
#if(Ena_Sel_Align_Way)
...
** 功能：设置字符大小
*/
#define	Ena_SetCharacterSize	0
#if(Ena_SetCharacterSize)
...
*/
#define	Ena_DownLoadBitmap	0
#if(Ena_DownLoadBitmap)
...
** 功能：
*/
#define	Ena_Set_LeftSpaceNum	0
#if(Ena_Set_LeftSpaceNum)
...
** 功能：选择中文编码格式
*/
#define	Ena_Set_ChineseCode	0
#if(Ena_Set_ChineseCode)
...
** 功能：打印自测页
*/
#define	Ena_TestPrintPage	0
#if(Ena_TestPrintPage)
...
** 功能：打印光栅位图
*/
#define	Ena_PrintGratinmap	0
#if(Ena_PrintGratinmap)
